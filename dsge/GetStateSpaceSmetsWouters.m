function [F,A0,H]=GetStateSpaceSmetsWouters(x,Y,T);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
[L,O,Q,Z]=qz(G0,G1);
[L,O,Q,Z]=qzdiv(1.0001,L,O,Q,Z); % Reorder the decomposition so  all the explosive eigenvalues are in the lower right corner.
...
Z1=Z(:,1:N-INST);
%
if INST==7 % Here exists determinacy
